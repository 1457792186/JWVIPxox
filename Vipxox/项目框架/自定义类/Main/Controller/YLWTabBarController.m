...
#warning -----    tabBar 第二项
    ...
    vc.viewControllers = [NSMutableArray arrayWithArray:@[[OnePayViewController class],[DepartmentViewController class]]];
    vc.titles=@[@"百货",@"一元购"];
...
//    ShopCarViewController *daigou = [[ShopCarViewController alloc]init];
    ...
    shoppingCar.viewControllers=[NSMutableArray arrayWithArray:@[[ShopCarViewController class],[JRSegmentViewController class]]];
    shoppingCar.titles=@[@"商城",@"百货"];
